...
function placeFetchedContent(data) {
    quote.placeContentIntoElement(textArea, '<span>Quote:</span> ' + data[0].quote);
    quote.placeContentIntoElement(authorArea, '<span>Author:</span> ' + data[0].author);
    quote.placeContentIntoElement(categoryArea, '<span>Category:</span> ' + (function() {
